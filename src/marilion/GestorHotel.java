...
public class GestorHotel {
    ...
    public void CrearReservacion() {
        ...
        System.out.println("Por ejemplo la fecha de hoy seria: " + CosasInutiles.FechaX.fechaEjemplo());
        Reader.consola.nextLine();
        reservMaz.fechaIni = CosasInutiles.FechaX.paser(Reader.consola.nextLine());
